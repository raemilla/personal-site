    ...
    return(
      <div id="modal2" className="modal modal-fixed-footer">
          <div className="modal-content">
            <h4><em>About Rachael</em></h4>
            <p><span><img src="/IMG_2328.jpg" style={{"height":"200px", "width":"150px", "padding":"5px", "marginRight":"5px","borderRadius":"50px", "float":"left"}}></img></span>I am a graduate of Boston University, earning a BA in Environmental Analysis and Policy. Though I loved what I learned in the classroom, as I started working towards a career, I felt unfulfilled despite hard work and perserverance. I've always loved to get my hands dirty: I feel best when I can tangibly point to my accomplishments. </p>
            ...
            <p>I finished Dev Bootcamp in October 2016 and am now pursuing a career in web development, with a particular interest towards front-end frameworks. Currently I work as a part-time developer at a financial technology startup in its very early stages, but am seeking long-term opportunities. I am excited to continue my love affair with coding and learn from hands-on experiences.</p>
