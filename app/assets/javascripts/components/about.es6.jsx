    ...
    return(
      <div id="modal2" className="modal modal-fixed-footer">
          <div className="modal-content">
            <h4>About Rachael</h4>
            <p><span><img src="/IMG_2328.jpg" style={{"height":"190px", "width":"150px", "padding":"5px", "margin-right":"5px","border-radius":"100px", "float":"left"}}></img></span>I am a graduate of Boston University, earning a BA in Environmental Analysis and Policy. Though I loved what I learned in the classroom, as I started working towards a career, I felt unfulfilled despite hard work and perserverance. I've always loved to get my hands dirty: I feel best when I can tangibly point to my accomplishments. </p>
